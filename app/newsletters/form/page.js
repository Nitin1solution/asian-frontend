    ...
    return (
        <>
            <Head>
                ...
                <link rel="stylesheet" href="https://cdn-images.mailchimp.com/embedcode/classic-061523.css" type="text/css" />
            </Head>
                        ...
                        <div className="col-lg-8">
                            <div className="blog-list row gy-5">
                                ...
                                <section className="container">
                                    <div className="mc_embed_signup_form" style={{margin:'50px'}}>
                                        <div id="mc_embed_signup">
                                            <div className="customcode customcodesubscribe">
                                                <form
                                                    ...
                                                    target="_blank"
                                                >
                                                    <div id="mc_embed_signup_scroll" style={{display:'grid',gridTemplateColumns:'repeat(2,1fr)',gap:'30px'}}>
                                                        <h2 className="open-sans">Subscribe</h2>

                                                        <div id="mce-responses" className="clear" style={{  }}>
                                                            <div className="response" id="mce-error-response" style={{ display: 'block' }}></div>
                                                            <div className="response" id="mce-success-response" style={{ display: 'block' }}></div>
                                                        </div>
                                                        ...
                                                        <div className="mc-field-group">
                                                            ...
                                                            <select name="ADDRESS[country]" id="mce-ADDRESS-country" className="inputastrisk">
                                                            ...
                                                            <option value="Turks &amp; Caicos Islands">Turks &amp; Caicos
                                                                Islands</option>
                                                            <option value="Jersey  (Channel Islands)">Jersey (Channel
                                                                Islands)</option>
