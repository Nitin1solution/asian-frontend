    ...
    const updateTime = async (countryName) => {
      try {
        const response = await fetch(
          `https://admin.asiandispatch.net/api/team/${countryName}`
        );
        ...
        <div className="tab-section">
          <div className="tab">
            ...
            <button
              ...
              onClick={(e) => openCity(e, "Editorial")}
              id="defaultOpen"
            >
            ...
            <button
              className="tablinks open-sans"
              onClick={(e) => openCity(e, "Members")}
            >
              Members
            </button>
            <button
              className="tablinks open-sans"
              onClick={(e) => openCity(e, "Operations")}
            >
              Operations & Video
            </button>
          </div>
              ...
              <div className="person" key={l.id}>
                ...
                <div className="person-info">
                  ...
                  <p className="open-sans">
                    <span
                      className={`country ${l.country_name
                        .toLowerCase()
                        .replace(" ", "-")}`}
                    />
                  </p>
            ...
            {editorials.map((e) => (
              <div className="person" key={e.id}>
                ...
                <div className="person-info">
                  ...
                  <p className="open-sans">
                    <span
                      className={`country ${e.country_name
                        .toLowerCase()
                        .replace(" ", "-")}`}
                    />
                  </p>
            ...
            {members.map((m) => (
              <div className="person" key={m.id}>
                ...
                <div className="person-info">
                  ...
                  <p className="open-sans">
                    <span
                      className={`country ${m.country_name
                        .toLowerCase()
                        .replace(" ", "-")}`}
                    />
                  </p>
            ...
            {operations.map((o) => (
              <div className="person" key={o.id}>
                ...
                <div className="person-info">
                  ...
                  <p className="open-sans">
                    <span
                      className={`country ${o.country_name
                        .toLowerCase()
                        .replace(" ", "-")}`}
                    />
                  </p>
