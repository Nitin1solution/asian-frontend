...
const Page = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const res = await fetch(`https://admin.asiandispatch.net/api/author/${id}/${name}`, {
                    cache: 'no-store',
                });
                                    ...
                                    <div className="author-widget">
                                        ...
                                        <div className="author-content">
                                            <h3>
                                                ...
                                                <span className="pt5 ls0_5 open-sans">{author.desi}</span>
                                                <p class="helvetica fwnormal">{author.bio}</p>
                                            </h3>
                                            <a href={author.twitter} target="_blank" className="tag-category hover-cat-color">
                                            ...
                                            <a href={author.instagram} target="_blank" className="tag-category hover-cat-color">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                        ...
                                        <ul className="widget-category-list">
                                            {categories.map((cat) => (
                                                <li key={cat.id} className="img-hover-move bgblack">
                                                    <Link href={`/category/${cat.slug}`} className="media wcolor hover-cat-color" >
                                                        {cat.category}
                                                    </Link>
                                                </li>
                                            ))}
