    ...
    const fetchData = async () => {
      try {
        const res = await fetch(
          `https://admin.asiandispatch.net/api/author/${id}/${name}`,
          {
            cache: "no-store",
          }
        );
                    ...
                    <div className="post-card horizontal-card img-hover-move">
                      ...
                      <div className="post-content">
                        ...
                        <h3>
                          <Link
                            href={`/${p.post_slug}`}
                            className="text-hover-category prata fs-20"
                          >
                            {p.post_title}
                          </Link>
                        </h3>
                ...
                <div className="sidebar-widget widget">
                  <div className="author-widget">
                    ...
                    <div className="author-content">
                      <h3>
                        <a href="#" className="author_name_single">
                          {author.name}
                        </a>
                        <span className="pt5 ls0_5 ">{author.desi}</span>
                        <p className="helvetica fwnormal">{author.bio}</p>
                      </h3>
                      ...
                      {author.twitter && (
                        <a
                          href={author.twitter}
                          target="_blank"
                          className="tag-category hover-cat-color"
                        >
                          <svg
                      ...
                      {author.linkedin && (
                        <a
                          ...
                          className="tag-category hover-cat-color"
                        >
                         <svg className="linkedin-author-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24"><path d="M4.98 3.5c0 1.381-1.11 2.5-2.48 2.5s-2.48-1.119-2.48-2.5c0-1.38 1.11-2.5 2.48-2.5s2.48 1.12 2.48 2.5zm.02 4.5h-5v16h5v-16zm7.982 0h-4.968v16h4.969v-8.399c0-4.67 6.029-5.052 6.029 0v8.399h4.988v-10.131c0-7.88-8.922-7.593-11.018-3.714v-2.155z"/></svg>
                        </a>
                      )}
                    </div>
                  </div>
                      ...
                      {categories.map((cat) => (
                        <li key={cat.id} className="img-hover-move bgblack">
                          <Link
                            ...
                            className="media wcolor hover-cat-color"
                          >
                            {cat.category}
                          </Link>
                        </li>
