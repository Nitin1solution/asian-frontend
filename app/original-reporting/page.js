...
async function getData() {
  try {
    const res = await fetch(
      "https://admin.asiandispatch.net/api/original-reporting",
      {
        cache: "no-store",
      }
    );
    ...
    <>
      ...
      <section className="page-header">
        <div className="container">
          <div
            className="page-content-wrap main-header-category"
            style={{
              backgroundImage: "url('/images/single/images.jpg')",
          ...
          >
            <div className="page-content">
              ...
              <p className="white">
                Investigations, features, cross-border collaborations, and
                explainers across beats by Asian Dispatch
              </p>
            </div>
          </div>
        </div>
                        ...
                        <div className="post-card horizontal-card img-hover-move category-card">
                          ...
                          <div class="post-content">
                            ...
                            <h3>
                              <Link
                                href={`/${post.post_slug}`}
                                className="category-title text-hover-category"
                              >
                                {post.post_title}
                              </Link>
                            </h3>
                            ...
                            <ul className="post-card-footer">
                              <li>
                                ...
                                >
                                  <h6 className="tag-category-single">
