...
async function getData() {
    try {
        const res = await fetch("https://admin.asiandispatch.net/api/original-reporting", {
            cache: 'no-store'
        });
                ...
                <div className="container">
                    <div className="page-content-wrap main-header-category"
                        ...
                        <div className="page-content">
                            ...
                            <p className="white">Investigations, features, cross-border collaborations, and explainers across beats by Asian Dispatch</p>
                        </div>
                    </div>
                </div>
            </section>
