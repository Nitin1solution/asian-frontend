...
export default async function Footer() {
  ...
  return (
    <>
      <footer className="footer-section-new  color-black">
        <div className="container">
          <div className="social-icons col-12 ">
            <div>
              <Link
                href="https://www.linkedin.com/company/asiandispatch/"
                target="_blank"
              >
                <svg
            ...
            <div>
              <Link
                href="https://www.instagram.com/asiandispatch"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
            ...
            <div>
              <Link href="https://twitter.com/asiandispatch_" target="_blank">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
            ...
            <div>
              <Link
                href="https://www.youtube.com/@AsianDispatch"
                target="_blank"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="nav-links col-12  ">
            {topics.map((topic) => (
              <Link
                ...
                className="open-sans"
                style={{ "--category-color": topic.color }}
              >
                {topic.category}
              </Link>
            ))}
          ...
          <div className="nav-links-1 col-12 ">
            <Link href="/who-we-are" className=" border-right open-sans">
              About Us
            </Link>

            <Link href="/press" className=" border-right open-sans">
              Press
            </Link>

            <Link href="/members" className=" border-right open-sans">
              Members
            </Link>

            <Link href="/contact-us" className="open-sans">
              Contact Us
            </Link>
          </div>
      ...
      <div id="scrollup">
        <button id="scroll-top" className="scroll-to-top">
          <svg
            ...
            fill="currentColor"
          >
            <path d="M450.001-180.001v-485.077L222.154-437.232 180.001-480 480-779.999 779.999-480l-42.153 42.768-227.847-227.846v485.077h-59.998Z"></path>
          </svg>
        </button>
      </div>
    </>
